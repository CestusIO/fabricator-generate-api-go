...
import (
	...
	"code.cestus.io/tools/fabricator-generate-api-go/pkg/fabricator-generate-api-go/templates"
)

// PluginName is the name of the plugin
const PluginName string = "fabricator-generate-api-go"
...
func NewFabricatorGenerateAPIGo(ioStreams fabricator.IOStreams, flagparser fabricator.FlagParser) *cobra.Command {
	//endregion
	cmd := &cobra.Command{
		Use:     PluginName,
